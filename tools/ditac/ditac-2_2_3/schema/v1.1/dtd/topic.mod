...
PUBLIC "-//OASIS//ELEMENTS DITA 1.1 Topic//EN"
...
<!ENTITY % topicDefns   PUBLIC 
                       "-//OASIS//ENTITIES DITA 1.1 Topic Definitions//EN" 
                       "topicDefn.ent"                              >
%topicDefns;

<!--                      Content elements common to map and topic -->
<!ENTITY % commonElements      PUBLIC 
"-//OASIS//ELEMENTS DITA 1.1 Common Elements//EN" "commonElements.mod"   >
%commonElements;

<!--                       MetaData Elements, plus indexterm       -->
<!ENTITY % metaXML         PUBLIC 
"-//OASIS//ELEMENTS DITA 1.1 Metadata//EN" 
"metaDecl.mod"                                                       >
%metaXML;
...
<!--                      Table Elements                           -->
<!--    2005.11.15 RDA: Corrected the public ID for tblDecl.mod,   -->
<!--  from the old value "-//OASIS//ELEMENTS DITA 1.1 CALS Tables//EN" -->
<!-- Tables are now part of commonElements -->
<!--<!ENTITY % tableXML       PUBLIC  
"-//OASIS//ELEMENTS DITA 1.1 Exchange Table Model//EN" 
"tblDecl.mod"                                                        >
%tableXML;-->
