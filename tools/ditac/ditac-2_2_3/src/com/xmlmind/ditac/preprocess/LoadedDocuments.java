...
/*package*/ class LoadedDocuments implements Constants {
    ...
    private boolean checkDITAVersion(LoadedDocument loadedDoc) {
    ...
    private boolean checkDITAVersion(Element element) {
    ...
    private void process(Node tree, URL baseURL) {
        ...
        while (child != null) {
            ...
            if (child.getNodeType() == Node.ELEMENT_NODE &&
                ...
                String value = DITAUtil.getNonEmptyAttribute(childElement,
                                                             null, "conref");
                if (value != null) {
    ...
    private void ensureHasValidID(Element element) {
    ...
    private void resolveHref(Element element, 
    ...
    private void resolveConkeyref(Element element, String attrValue) {
    ...
    private String[] splitKeyref(Element element,
                                 String attrName, String attrValue) {
        String key, id;
    ...
    private static String addIdToHref(String href, String id) {
        if (id != null) {
    ...
    private void processKeyref(Element element, String attrValue) {
    ...
    private void addContent(Keys.Entry entry, Element element) {
    ...
    private static Element copyElement(Element from, 
    ...
    private void addContent2(Keys.Entry entry, Element element) {
    ...
    private static void listTopics(LoadedTopic[] topics, int indent) {
