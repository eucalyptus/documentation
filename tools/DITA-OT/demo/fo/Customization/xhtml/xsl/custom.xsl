...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	exclude-result-prefixes="opentopic" version="1.1">
		...
		<xsl:if test="descendant::*[contains(@class,' topic/topic ')]">
			...
			<!--<p>
				<table width="150" align="right" border="1" frame="box" rules="none">
					<tr>
						<td height="5" bgcolor="#0033CC" align="center">
							<b>
								<font color="#FFFFFF">Contents:</font>
							</b>
						</td>
					</tr>
					<xsl:for-each select="descendant::*[contains(@class,' topic/topic ')]">
						...
						<tr>
							<td class="toc"> - <a href="#{generate-id()}"><xsl:value-of select="$ttext"/></a>
	...
	<xsl:template name="createFrontMatter">
		<xsl:value-of
			select="$map/*[contains(@class,' map/topicmeta ')]/*[contains(@class,'
			topic/publisher ')]"/>
