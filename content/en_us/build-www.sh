...
for DOC_NAME in admin-guide console-guide euca2ools-guide faststart-guide hybrid-guide install-guide release-notes release-notes-euca2ools troubleshooting-guide user-guide; do
